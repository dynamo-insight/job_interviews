...
Welcome to ``job_interviews`` contributor's guide.
...
If you experience bugs or general issues with ``job_interviews``, please have a look
...
You can help improve ``job_interviews`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``job_interviews`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``job_interviews``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n job_interviews python=3 six virtualenv pytest pytest-cov
    conda activate job_interviews
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/job_interviews.git
    cd job_interviews
...
#. Install |pre-commit|_::
   ...
   ``job_interviews`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/job_interviews
.. _issue tracker: https://github.com/<USERNAME>/job_interviews/issues
.. <-- end -->
